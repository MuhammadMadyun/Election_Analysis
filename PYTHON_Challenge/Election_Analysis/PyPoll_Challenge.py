...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > county_voter_turnout ) and (county_vote_percentage > winning_county_percentage):
    ...
    winning_county_summary = (
        f"-------------------------\n"
        f"Winning County: {largest_county}\n"
        f"Vote Count: {county_voter_turnout,}\n"
